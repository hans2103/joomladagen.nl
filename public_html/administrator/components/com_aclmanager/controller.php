...
class AclmanagerController extends JControllerLegacy
{
	...
	function __construct()
	{
		...
		if ($layout =='print') {
			$doc->addStyleSheet(JURI::root(true).'/administrator/components/com_aclmanager/assets/css/print.css?v=2.5.4');
		} else {
			$doc->addStyleSheet(JURI::root(true).'/administrator/components/com_aclmanager/assets/css/aclmanager.css?v=2.5.4');
		}
	}
