...
require_once(JPATH_ADMINISTRATOR.DS."components".DS."com_jticketing".DS."config.php");
...
<div  class="techjoomla-bootstrap">
	<table border="0" width="100%" cellspacing="10" class="adminlist">
		<tr>
			...
			{
			    $cssfile = JPATH_SITE.DS."components".DS."com_jticketing".DS."assets".DS."css".DS."email.css";
			...
			<td width="50%" valign="top">
				<table>
					...
					<tr>
						...
						<td><?php echo JText::_('TAGS_BUYER_NAME'); ?></td>
					</tr>
					<tr>
