 ...
 * @since  1.6
 */
class JticketingTablevenue extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_jticketing.venue.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_jticketing/access.xml',
				"/access/section[@name='venue']/"
			);
			$default_actions = JAccess::getAssetRules('com_jticketing.venue.' . $array['id'])->getData();
			$array_jaccess   = array();
