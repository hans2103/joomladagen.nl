...
?>
<div class="span10">
	<?php echo $this->pspForm->renderFieldset('mollie'); ?>
</div>
<div class="span2">
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td class="center"><?php echo JHtml::_('link', 'https://www.mollie.nl/', JHtml::_('image', 'com_jdidealgateway/mollie.jpg', 'Mollie', false, true), 'target="_new"'); ?></td>
				<td></td>
			</tr>
		</tbody>
	</table>
