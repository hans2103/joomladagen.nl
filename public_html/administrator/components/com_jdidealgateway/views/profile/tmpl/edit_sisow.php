...
?>
<div class="span10">
	<?php echo $this->pspForm->renderFieldset('sisow'); ?>
</div>
<div class="span2">
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td class="center"><?php echo JHtml::_('link', 'http://www.sisow.nl/', JHtml::_('image','com_jdidealgateway/sisow.png', 'Sisow', false, true), 'target="_new"'); ?></td>
				<td></td>
			</tr>
		</tbody>
	</table>
