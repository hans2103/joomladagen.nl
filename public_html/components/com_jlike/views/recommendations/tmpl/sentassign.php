...
<div class="techjoomla-bootstrap">
	<form action="<?php echo JRoute::_('index.php?option=com_jlike&view=recommendations&layout=sentassign'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="no-more-tables">
			<table class="table table-striped" id = "todosList" >
				<thead >
					<tr>
						...
						<th >
						<?php echo JHtml::_('grid.sort',  'COM_JLIKE_ASSIGNED_TO', 'a.assigned_to', $listDirn, $listOrder); ?>
						</th>
			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td data-title="<?php echo JText::_("COM_JLIKE_ASSIGNED_TO"); ?>">
