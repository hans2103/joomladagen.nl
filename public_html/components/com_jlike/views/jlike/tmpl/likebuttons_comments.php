						...
						<div class="jlike_position_relative pull-right">
							...
							<ul class="dropdown-menu jlike_edit_dropdown jlike_list_style_type" >
								<li id="showEditDeleteButton<?php echo $comment->annotation_id; ?>" tabindex="-1">
									<a target="#showEditDeleteButton<?php echo $comment->annotation_id; ?>" onclick="EditComment(this)"><?php echo JText::_('COM_JLIKE_EDIT'); ?></a>
								</li>
								<li id="DeleteButton<?php echo $comment->annotation_id; ?>" tabindex="-1">
									<a target="#DeleteButton<?php echo $comment->annotation_id; ?>" onclick="DeleteComment(this)"><?php echo JText::_('COM_JLIKE_DELETE'); ?></a>
								</li>
							</ul>
						</div>
						<?php } ?>
								...
								{ ?>
									<span >
										<span id="jlike_cancel_comment_btn<?php echo $comment->annotation_id;?>" class=" jlike_cancel_comment_btn jlike_display_none" >
											<button type="button" class='btn jlike_cancelbtn' onclick="Cancel(<?php echo $comment->annotation_id; ?>)"> <?php echo JText::_('COM_JLIKE_CACEL'); ?></button>
											<button type="button" class='btn jlike_commentbtn' onclick="SaveEditedComment(<?php echo $comment->annotation_id; ?>,<?php echo $comment->annotation_id; ?>)"> <?php echo JText::_('COM_JLIKE_COMMENT'); ?></button>
										</span>
									</span>
								<?php
								} ?>
	...
	<div class="row-fluid">
		...
		<div class="modal jlike_modal fade" id="like_dislike_users ">
			...
			<div class="modal-footer">
				<a href="#" class="btn" data-dismiss="modal"><?php echo JText::_('COM_JLIKE_CLOSE'); ?></a>
			</div>
		</div>
