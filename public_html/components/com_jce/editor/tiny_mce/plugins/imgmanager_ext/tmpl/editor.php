...
<form onsubmit="return false;">
    <div id="editor" class="offleft">
        ...
        <div id="editor-tools">
            ...
            <!--div id="editor_image_slider" class="slider">
                <span class="slider-image-left"></span>
                <input type="range" min="10" max="100" step="10" disabled="disabled" aria-disabled="true" />
                <span class="slider-image-right"></span>
            </div-->
