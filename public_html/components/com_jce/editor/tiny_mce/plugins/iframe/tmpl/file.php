    ...
    <div class="uk-width-4-5 uk-width-mini-1-1">
      ...
      <div class="uk-grid uk-grid-small">
        ...
        <div class="uk-grid uk-grid-small">
            ...
            <div class="uk-form-controls uk-width-3-4 uk-flex-item-auto">
                <input type="text" id="width" value="" required />
        ...
        <div class="uk-grid uk-grid-small">
            ...
            <div class="uk-width-2-5 html4">
              <label for="frameborder" class="hastip uk-form-label uk-width-3-5"
                     title="<?php echo JText::_('WF_IFRAME_FRAMEBORDER_DESC'); ?>"><?php echo WFText::_('WF_IFRAME_FRAMEBORDER'); ?></label>
        ...
        <div class="uk-grid uk-grid-small html4">
          <label for="scrolling" class="hastip uk-form-label uk-width-1-5"
                 title="<?php echo WFText::_('WF_IFRAME_SCROLLING_DESC'); ?>">
