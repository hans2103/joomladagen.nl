...
<?php foreach ($form->getGroup('') as $field) : ?>
	<?php
		$form = str_replace('control-group', 'form-group', $field->renderField());
		$col = str_replace('control-label', 'col-lg-2 col-md-2 col-sm-3 col-xs-12', $form);
		echo str_replace('form-label', 'col-lg-2 col-md-2 col-sm-3 col-xs-12', $col);
	?>
<?php endforeach; ?>
</div>
