...
<div class="span4">
	...
	<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
		...
		<?php elseif($urls):?>
		<a class="thumbnail" href="<?php echo $urls->urla; ?>">
		<?php else:?>
...
<?php endif; ?>
	...
	<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
			...
			<?php if ($params->get('show_publish_date')) : ?>
					...
					<div class="published">
						<span class="icon icon-clock"></span> <?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC2'))); ?>
					</div>
	...
	<?php if ($params->get('show_readmore') && $this->item->readmore) :
		...
		?>
		<a class="btn btn-small pull-right" href="<?php echo $link; ?>"> 
