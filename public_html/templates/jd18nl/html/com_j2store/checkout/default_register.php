...
//we dont have a profile set in the store profile. So use the default one.
	...
	if ($status == false)
	{
		...
		$email .= ' <label id="email-lbl" for="email" class="form-label required">' . JText::_('J2STORE_EMAIL') . '<span class="star">&nbsp;*</span></label>';
		$email .= ' <input type="text" name="email" id="email" value="" class="form-input validate-email required" size="25" placeholder="' . JText::_('J2STORE_EMAIL') . '" required="" aria-required="true">';
		$email .= '</div>';
	...
	$password .= ' <label id="password-lbl" for="password" class="form-label required">' . JText::_('J2STORE_CHECKOUT_ENTER_PASSWORD') . '<span class="star">&nbsp;*</span></label>';
	$password .= ' <input type="password" name="password" id="password" value="" class="form-input validate-password required" size="25" placeholder="' . JText::_('J2STORE_CHECKOUT_ENTER_PASSWORD') . '" required="" aria-required="true">';
	$password .= '</div>';
    ...
    <div class="buttons">
        <div class="left">
            <input type="button" value="<?php echo JText::_('J2STORE_CHECKOUT_CONTINUE'); ?>" id="button-register"
