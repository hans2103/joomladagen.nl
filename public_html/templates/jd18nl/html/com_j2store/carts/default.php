				...
				<span class="cart-continue-shopping-button">
					<?php if ($this->continue_shopping_url->type != 'previous'): ?>
                        <input class="btn btn-primary" type="button"
                               onclick="window.location='<?php echo $this->continue_shopping_url->url; ?>';"
                               value="<?php echo JText::_('J2STORE_CART_CONTINUE_SHOPPING'); ?>"/>
					<?php else: ?>
                        <input class="btn btn-primary" type="button" onclick="window.history.back();"
                               value="<?php echo JText::_('J2STORE_CART_CONTINUE_SHOPPING'); ?>"/>
					<?php endif; ?>
					...
					<input class="btn btn-warning" type="submit"
                           value="<?php echo JText::_('J2STORE_CART_UPDATE'); ?>"/>
				</span>
                                        </div>
									...
									<a class="btn btn-danger"
                                       href="<?php echo JRoute::_('index.php?option=com_j2store&view=carts&task=clearCart'); ?>"><?php echo JText::_('J2STORE_EMPTY_CART') ?></a>
								</span>
											<?php endif; ?>
                                        </div>
                                    </div>
