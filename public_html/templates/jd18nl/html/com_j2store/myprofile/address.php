...
$array = array(
	'title' => JText::_('J2STORE_ADDRESS_EDIT')
);
...
<section class="section__wrapper">
    <div class="container">
        <div class="article__item article__item--shift">
            ...
            <form id="j2storeaddressForm" name="addressForm" method="post" action="<?php echo JRoute::_('index.php?option=com_j2store&view=myprofile'); ?>">
                <div id="address">
                    <div class="j2store-address-alert">
                    </div>
                    <div class="pull-right">
                        <a onclick="J2storeSubmitForm(this,'apply')" class="button btn btn-success"><span
                                    class="icon-apply icon-white"></span><?php echo JText::_('JSAVE'); ?></a>
                        <a onclick="J2storeSubmitForm(this,'save')" class="button btn "><span
                                    class="icon-save"></span><?php echo JText::_('JTOOLBAR_SAVE'); ?></a>
                    </div>
                    <div class="pull-left">
					...
					if (empty($html) || JString::strlen($html) < 5)
					{
						...
						$html = '<div class="' . $J2gridRow . ' j2store address--edit">
			...
			<div class="' . $J2gridCol . '6">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
                ...
                <input type="hidden" id="address_id" name="address_id"
                       value="<?php echo $this->address->j2store_address_id; ?>"/>
                <input type="hidden" id="j2store_address_id" name="j2store_address_id"
                       value="<?php echo $this->address->j2store_address_id; ?>"/>
