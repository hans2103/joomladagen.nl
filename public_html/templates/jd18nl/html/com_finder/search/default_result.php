...
?>
<a href="<?php echo JRoute::_($route); ?>" class="search__result">
    <h4 class="result-title <?php echo $mime; ?>"><?php echo $this->result->title; ?></h4>
	...
	<?php if ($this->params->get('show_url', 1)) : ?>
        <div class="result-url<?php echo $this->pageclass_sfx; ?>">
