...
$this->form->loadFile(dirname(__FILE__) . "/../models/forms/reset_complete.xml");
...
<section class="section__wrapper">
    <div class="container container--shift">
        <div class="content content--shift content__form content__form--reset-complete">

            <form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.complete'); ?>" method="post" class="form-validate form__pwt">
