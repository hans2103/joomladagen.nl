...
$this->form->loadFile(dirname(__FILE__) . "/../models/forms/reset_confirm.xml");
...
<section class="section__wrapper">
    <div class="container container--shift">
        <div class="content content--small content__form content__form--reset-confirm">

            <form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="form-validate form__pwt">
