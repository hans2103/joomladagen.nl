...
$this->form->loadFile(dirname(__FILE__) . "/../models/forms/remind.xml");
...
<section class="section__wrapper">
    <div class="container container--shift">
        <div class="content content--small content__form content__form--remind">

            <form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="form-validate form__pwt">
