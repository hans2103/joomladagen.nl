 ...
 */
class AdminToolsUpdate extends AdmintoolsCliBase
{
	...
	public function execute()
	{
		...
		if ($this->input->get('quiet', -1, 'int') == -1)
		{
			$year = gmdate('Y');
			echo <<<ENDBLOCK
Admin Tools Update $version ($date)
...
$debugmessage
Checking for new Admin Tools versions
...
AdmintoolsCliBase::getInstance('AdminToolsUpdate')->execute();