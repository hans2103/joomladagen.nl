...
class JFormFieldCredensial extends JFormFieldList {
    ...
    public function getInput() {
        ...
        $url = trim(JURI::root(),'/').'/index.php?option=com_j2store&view=crons&command=paypal_api_check&cron_secret='.$cron_key;
        $html = "<a id='check_credensial' onclick='checkPaypalCredensial()' class='btn btn-primary'>".JText::_('J2STORE_PAYPAL_CREDENTIALS_CHECK')."</a>";
        $html .= "<script>function checkPaypalCredensial(){
        (function($) {
