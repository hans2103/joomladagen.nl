...
<!--SHIPPING ADDRESS PROVIDED-->
    ...
    ?>
    	...
    	<input type='hidden' name='item_name_<?php echo $i;?>' value='<?php echo substr($this->clean_title($product['name']), 0,127);?>' />
        <input type='hidden' name='item_number_<?php echo $i;?>' value='<?php echo isset($product['number']) ? substr($product['number'], 0,127) : ''; ?>' />
...
<!-- payment screen style variables -->
	...
	<input type="hidden" name="image_url" value="<?php echo substr($image_url, 0,1024);?>" />
	<?php endif; ?>
